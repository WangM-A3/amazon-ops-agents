...
class MockDataGenerator:
    ...
    def query_inventory(
        ...
        if sku:
            ...
            result = {**data, "quantity": int(self._fluctuate(data["quantity"]))}
        else:
            result = [
    ...
    def query_suppliers(self, supplier_id: Optional[str] = None) -> APIResponse:
        ...
        if supplier_id:
            ...
            result = list(MOCK_SUPPLIERS.values())
        return APIResponse(
            success=True,
            data=result,
            source="mock",
    ...
    def query_shipments(self, tracking_no: Optional[str] = None) -> APIResponse:
        ...
        if tracking_no:
            ...
            result = list(MOCK_SHIPMENTS.values())
        return APIResponse(
            success=True,
            data=result,
            source="mock",
    ...
    def query_finance(
        ...
        result = {}
        if budget_summary:
            result["budget_summary"] = MOCK_FINANCE["budget_summary"]
        if recent_payments:
            result["recent_payments"] = MOCK_FINANCE["recent_payments"]
        return APIResponse(
            success=True,
            data=result,
            source="mock",
